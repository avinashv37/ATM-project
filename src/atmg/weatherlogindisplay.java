					...
					if (nNode.getNodeType() == Node.ELEMENT_NODE) {
						...
						for (int tempr = 0; tempr < nl3.getLength(); tempr++) {
							...
							if (nNode.getNodeType() == Node.ELEMENT_NODE) {
								...
								builder.append(
										"\n" + "Temperature              :" + e3.getAttribute("temp") + " " + unit);
							}
						}
						...
						NodeList nl5 = eElement.getElementsByTagName("yweather:condition");
						...
						NodeList nl6 = eElement.getElementsByTagName("yweather:forecast");
